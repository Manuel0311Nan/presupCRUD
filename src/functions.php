...
function sendEmail($email, $asunto, $body, $path, $titulo)
{
  ...
  $mail->Username = "info@azkenservices.com";
  $mail->Password = 'azk44MUGA';
  $mail->FromName = "BODEGAS TRADICIÓN";
  $mail->AddAttachment($path,   $titulo . '.pdf', 'base64', 'application/pdf');
  $mail->setFrom("info@azkenservices.com", "Incidencia - Comapes");
  if (is_array($email)) {
